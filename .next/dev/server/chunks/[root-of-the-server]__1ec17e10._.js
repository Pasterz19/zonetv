...
"[project]/src/app/api/watch/progress/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (movieId) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeSql"])(`INSERT INTO WatchProgress (id, userId, movieId, timestamp, updatedAt)
         VALUES (?, ?, ?, ?, datetime('now'))
         ON CONFLICT(userId, movieId) DO UPDATE SET
           ...
           updatedAt = datetime('now')`, [
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeSql"])(`INSERT INTO WatchProgress (id, userId, episodeId, timestamp, updatedAt)
         VALUES (?, ?, ?, ?, datetime('now'))
...
async function GET(request) {
    try {
        ...
        if (movieId) {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT timestamp FROM WatchProgress WHERE userId = ? AND movieId = ?`, [
                userId,
                movieId
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (episodeId) {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT timestamp FROM WatchProgress WHERE userId = ? AND episodeId = ?`, [
                userId,
                episodeId
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ec17e10._.js.map